...
public class OldInput : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.D))
        {
            controller.IsOnBackward = true;
        }
        else if (Input.GetKeyUp(KeyCode.D))
        {
            controller.IsOnBackward = false;
        }
